document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentProfessor) {
        ...
        section.innerHTML = `
            ...
            <button onclick="alert('Contact ${currentProfessor.name}')">Contact</button>
            <button onclick="alert('Added ${currentProfessor.name} to Broadcast List')">Add to Broadcast List</button>
        `;
    }
}); 